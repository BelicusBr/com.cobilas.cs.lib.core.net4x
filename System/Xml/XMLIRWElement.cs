...
namespace System.Xml { 
    ...
    public class XMLIRWElement : XMLIRW, ITextValue, IXMLIRWCollection {
        ...
        public XMLIRWElement(XMLIRW parent, string name, object value, params XMLIRW[] itens)
            ...
            Name = name;
            this.Text = value is XMLIRWText txt ? txt : new XMLIRWText(value);
            this.itens = [];
        ...
        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(XMLIRW parent, string name, object value) : this(parent, name, value, []) {}
        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(XMLIRW parent, string name, params XMLIRW[] itens) : this(parent, name, XMLIRWTextNull.Null, itens) {}

        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(string name, object value, params XMLIRW[] itens) : this(XMLIRWNull.Null, name, value, itens) {}
        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(string name, object value) : this(XMLIRWNull.Null, name, value, []) {}
        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(string name, params XMLIRW[] itens) : this(XMLIRWNull.Null, name, XMLIRWTextNull.Null, itens) {}
        /// <inheritdoc cref="XMLIRW()"/>
        public XMLIRWElement(string name) : this(XMLIRWNull.Null, name, XMLIRWTextNull.Null) {}
